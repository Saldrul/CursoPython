...
# Ejercicio 3
# def perimeter_calculator(radius: float) -> float:
#     radio = radius
#     perimetro = (2 * math.pi * radio)
#     return perimetro
#
#
# print(perimeter_calculator(20.5))


# Ejercicio 4

# print("Calcularemos el área a partir de un radio.")
# radio = radius
# area = 3.1416 * (radio**2)
# print("Su area es : ", area)

# def area_calculator(radius: float) -> float:
#     radio = radius
...
# def ten_percent_increase(number: float) -> float:
#     number *= 1.1
#     return number
